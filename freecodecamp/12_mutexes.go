...
// Mutexes in GO
// Mutexes are used to synchronize access to shared state across multiple goroutines.
// In this example, the state is a map.
// This map is accessed by 100 goroutines, and we use a mutex to synchronize access.
